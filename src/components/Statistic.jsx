  ...
  <div className="container px-5 md:py-24 mx-auto flex flex-wrap">
    <div className="flex flex-wrap mt-auto mb-auto lg:w-1/2 sm:w-2/3 content-start sm:pr-10">
      <div className="w-full sm:p-4 px-4 mb-6">
        <h1 className="sm:text-3xl text-2xl title-font font-medium text-customHeading mb-4">Zawiyah by the Numbers</h1>
      ...
      <div className='flex justify-between m-auto md:m-0 w-max md:gap-5 px-4'>
        <div className="">
