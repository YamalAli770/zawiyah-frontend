...
const Hero = () => {
  ...
  <div className="container mx-auto flex px-5 py-0 md:py-24 md:flex-row flex-col items-center">
    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-customHeading">
      ...
      <div className="flex justify-center">
        <Link to="/shop" className="inline-flex text-customButtonText bg-customButtonBg border-0 py-2 px-6 focus:outline-none hover:brightness-50 rounded text-lg">Shop Now</Link>
      </div>
    </div>
